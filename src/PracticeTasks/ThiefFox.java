...
*/
    public class ThiefFox {
       ...
       /*     boolean fox1WearsCoat = true;
            ...
            eachFox(true,true,"BLACK",0,"Fox1");
            eachFox(true,true,"BLACK",3,"Fox2");
            eachFox(true,true,"BLACK",2,"Fox3");
            eachFox(true,true,"GRAY",3,"Fox4");
...
*/
    ...
    public static void eachFox(boolean hasCoat, boolean hasTourch,String coatColor, int bagCount,String foxName ){

        if (hasCoat && coatColor.equals("BLACK") && hasTourch && bagCount == 3) {
            System.out.println("\uD83E\uDD8A "+ foxName+" is one of suspects! \uD83E\uDD14");
        } else {
