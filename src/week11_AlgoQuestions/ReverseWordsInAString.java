...
public class ReverseWordsInAString {
    ...
    public static void main(String[] args) {
        ...
        reverseTheSentence("the sky is  blue");


    }


    public static void reverseTheSentence(String sentence) {
        String[] sentenceArray = sentence.trim().split("\\s+"); // Split on one or more spaces

        StringBuilder reversedSentence = new StringBuilder();

        for (int i = sentenceArray.length - 1; i >= 0; i--) {
            reversedSentence.append(sentenceArray[i]).append(" ");
        }
